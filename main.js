...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(_App2.default, null), document.getElementById('mars-app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Accepted = __webpack_require__(170);
	
	var _Accepted2 = _interopRequireDefault(_Accepted);
	
	var _Rejected = __webpack_require__(171);
	
	var _Rejected2 = _interopRequireDefault(_Rejected);
	
	var _Begin = __webpack_require__(173);
	
	var _Begin2 = _interopRequireDefault(_Begin);
	
	var _Tester = __webpack_require__(174);
		...
		_createClass(App, [{
			...
			value: function _renderPage() {
				switch (this.state.page) {
					case "home":
						return React.createElement(_Home2.default, { navigate: this._navigate.bind(this) });
						break;
					case "begin":
						return React.createElement(_Begin2.default, { navigate: this._navigate.bind(this) });
						break;
					case "test":
						return React.createElement(_Tester2.default, { navigate: this._navigate.bind(this) });
						break;
					case "accepted":
						return React.createElement(_Accepted2.default, { navigate: this._navigate.bind(this) });
						break;
					case "rejected":
						return React.createElement(_Rejected2.default, { navigate: this._navigate.bind(this) });
				}
			}
		}, {
			key: "render",
	...
	var Home = function (_React$Component) {
		...
		_createClass(Home, [{
			...
			value: function render() {
				return React.createElement(
					"div",
					{ className: "comp-style" },
					React.createElement(
						"button",
						{ onClick: this._beginTest.bind(this) },
						"Take Quiz"
					)
				);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Accept = function (_React$Component) {
		_inherits(Accept, _React$Component);
	
		function Accept() {
			_classCallCheck(this, Accept);
	
			return _possibleConstructorReturn(this, Object.getPrototypeOf(Accept).apply(this, arguments));
		}
		...
		_createClass(Accept, [{
			...
			value: function render() {
				return React.createElement(
					"div",
					{ className: "compt-style" },
					React.createElement(
						"h1",
						{ className: "accepted" },
						"Accepted"
					),
					React.createElement("i", { className: "launch fa fa-space-shuttle fa-rotate-270", "aria-hidden": "true" })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Rejected = function (_React$Component) {
		_inherits(Rejected, _React$Component);
	
		function Rejected() {
			_classCallCheck(this, Rejected);
	
			return _possibleConstructorReturn(this, Object.getPrototypeOf(Rejected).apply(this, arguments));
		}
	
		_createClass(Rejected, [{
			key: '_quiz',
			value: function _quiz() {
			...
			value: function render() {
				return React.createElement(
					...
					React.createElement(
						'div',
						{ className: 'retry-timer' },
						React.createElement(_Timer2.default, { navigate: this.props.navigate })
					),
					React.createElement(
						'h1',
						{ className: 'rejected' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Timer2 = function (_React$Component) {
	  _inherits(Timer2, _React$Component);
	
	  function Timer2(props) {
	    _classCallCheck(this, Timer2);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Timer2).call(this, props));
	  ...
	  _createClass(Timer2, [{
	    ...
	    value: function _renderMinutes() {
	      var minutes = Math.floor(this.state.secondsElapsed / 60);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Begin = function (_React$Component) {
		...
		function Begin() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(Begin).apply(this, arguments));
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Timer = __webpack_require__(175);
	...
	var TestPage = function (_React$Component) {
		...
		function TestPage(props) {
			...
			_this.state = { question: 0, correct: 0 };
		...
		_createClass(TestPage, [{
			...
			value: function render() {
				return React.createElement(
					...
					React.createElement(
						'div',
						{ className: 'quiz-box-wrapper' },
						React.createElement(
							'div',
							{ className: 'quiz-box-container' },
							React.createElement(
								'p',
								null,
								benQuestion[this.state.question].question
							),
							React.createElement(
								'form',
								{ className: 'quiz-input' },
								React.createElement('input', { type: 'text', ref: 'quizInput' })
							),
							React.createElement(
								'div',
